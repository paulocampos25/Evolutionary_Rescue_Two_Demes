...
int main(int ac, char **av)
{
  ...
  sprintf(arq2,"Min_Distance-Metapopulation-K%d-Lambda%g-ntraits%d-U%g-mig%g-drop%g-Wmax%g.dat",popul.K,popul.lambda,popul.ntraits,popul.mut,popul.migration,drop_fitness[1],sequence.W_max);
  ptt2 = fopen(arq2,"a");
