...
int main(int ac, char **av)
{
  ...
  sprintf(arq2,"General-Fixation-K%d-Lambda%g-ntraits%d-mig%g-drop%g-Wmax%g.dat",popul.K,popul.lambda,popul.ntraits,popul.migration,drop_fitness[1],sequence.W_max);
  ptt2 = fopen(arq2,"a");
